import { BaseConverter } from "./baseConverter.util.js";
...
export class Bytes {
    ...
    static base62 = {
         ...
         */
        encode(blob) {
            return BaseConverter.toString(Bytes.bigint.encode(blob), 62);
        },
        /**
         * Decode in bytes
         ...
         */
        decode(base62string) {
            return Bytes.bigint.decode(BaseConverter.fromString(base62string, 62));
        },
    };
