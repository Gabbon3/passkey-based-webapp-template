...
import { verifyAuth, verifyPulsePrivilegedToken } from "../middlewares/auth/auth.middlewares.js";
// -- router
 ...
 * /pulse/*
 */
router.post('/ppt', verifyAuth(), controller.pulsePrivilegedToken);
...
// API DI TEST
router.post('/ppt-test', verifyPulsePrivilegedToken, (req, res, next) => {
